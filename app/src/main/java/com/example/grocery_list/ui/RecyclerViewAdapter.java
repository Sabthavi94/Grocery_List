...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void editItem(final Item newItem) {
            ...
            groceryItem.setText(newItem.getItemName());
            ...
            saveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //update items
                    newItem.setItemName(groceryItem.getText().toString());
                    ...
                    if (!groceryItem.getText().toString().isEmpty()
                        ...
                        notifyItemChanged(getAdapterPosition(),newItem); //important to add to show update when popup closed!
